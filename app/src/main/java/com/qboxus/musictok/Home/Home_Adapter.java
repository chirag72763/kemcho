...
import com.qboxus.musictok.Home.transformation.BlurTransformation;
...
public class Home_Adapter extends RecyclerView.Adapter<Home_Adapter.CustomViewHolder > {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout like_layout,comment_layout,shared_layout,sound_image_layout,send_coin_layout;
        ...
        public CustomViewHolder(View view) {
            ...
            send_coin_layout=view.findViewById(R.id.send_coin_layout);
        ...
        public void bind(final int postion,final Home_Get_Set item, final Home_Adapter.OnItemClickListener listener) {
            ...
            send_coin_layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
