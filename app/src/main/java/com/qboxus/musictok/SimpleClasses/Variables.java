...
public class Variables {
    ...
    public static final String app_hided_folder =root+"/.HidedKemCho/";
    public static final String app_showing_folder =root+"/KemCho/";
   ...
   public static String gif_api_key1="giphy_api_key_here";
    ...
    public static final  String main_domain="http://kem-cho.com/";
    ...
    public static final String sendCoin= api_domain +"sendCoin";
    public static final String coin_plan = api_domain +"coin_plan";
    public static final String purchesCoin= api_domain +"purchesCoin";
    public static final String getWallet = api_domain +"getWallet";
    public static final String reedem = api_domain + "reedem";
    public static final String gift_plan = api_domain +"gift_plan";
