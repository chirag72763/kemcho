...
public class Video_Recoder_A extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView short_video_time_txt,long_video_time_txt,high_video_time_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        high_video_time_txt=findViewById(R.id.high_video_time_txt);

        short_video_time_txt.setOnClickListener(this);
        long_video_time_txt.setOnClickListener(this);
        high_video_time_txt.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.short_video_time_txt:
                ...
                param7.addRule(RelativeLayout.END_OF,R.id.short_video_time_txt);
                high_video_time_txt.setLayoutParams(param7);
                ...
                high_video_time_txt.setTextColor(getResources().getColor(R.color.graycolor2));
            ...
            case R.id.long_video_time_txt:
                ...
                param8.addRule(RelativeLayout.RIGHT_OF,R.id.short_video_time_txt);
                high_video_time_txt.setLayoutParams(param8);
            ...
            case R.id.high_video_time_txt:
                ...
                high_video_time_txt.setLayoutParams(param5);
                ...
                param6.addRule(RelativeLayout.END_OF,R.id.high_video_time_txt);
                ...
                param9.addRule(RelativeLayout.END_OF,R.id.short_video_time_txt);
                long_video_time_txt.setLayoutParams(param9);

                short_video_time_txt.setTextColor(getResources().getColor(R.color.graycolor2));
                long_video_time_txt.setTextColor(getResources().getColor(R.color.graycolor));
                high_video_time_txt.setTextColor(getResources().getColor(R.color.white));

                Variables.recording_duration=600000;
